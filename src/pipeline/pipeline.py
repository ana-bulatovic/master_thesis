...
class NLPPipeline:
    ...
    def _needs_sarcasm_detector(self) -> bool:
        pipeline_config = self.config.pipeline_config
        return (
            pipeline_config.use_sarcasm_detection
            or pipeline_config.use_sarcasm_for_summarization
            or pipeline_config.use_sarcasm_for_sentiment
        )

    def _uses_sarcasm(self) -> bool:
        return self._needs_sarcasm_detector()
    ...
    def print_config_summary(self) -> None:
        ...
        print(f"  Sarcasm for sentiment:     {pipeline_config.use_sarcasm_for_sentiment}")
